...
ModelEma = ModelEmaV2
# allneighbor: e_embed for neighbor, mask_atom for neighbor
# neighbor: e_embed for batch, mask_atom for neighbor
file_name = "reverseE_0.1_0.1_neighbor_mask2_onemole_fclogit"
# file_name = "singlefocus_exp"
def get_args_parser():
...
class kl_circ(nn.Module):
    def __init__(self, res=100):
        super().__init__()
        # self.s2 = o3.Tokl_circS2Grid(1, (res, res + 1))
